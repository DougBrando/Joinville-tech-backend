...
-- Tabela professores: já tem chave primária (id)
...
-- Tabela estudantes: já tem chave primária (id)
...
-- Tabela cursos: já tem chave primária (id), precisa de FK para professor_id
...
    professor_id bigint,  -- Será referenciada por FK
    numero_maximo_alunos bigint NOT NULL,
    PRIMARY KEY (id)
);

-- Tabela estudantes_cursos: já tem chave primária (id), precisa de FKs para estudante_id e curso_id
...
-- FK em cursos para professores (professor_id)
...
-- FK em estudantes_cursos para estudantes (estudante_id)
...
-- FK em estudantes_cursos para cursos (curso_id)
ALTER TABLE IF EXISTS public.estudantes_cursos
